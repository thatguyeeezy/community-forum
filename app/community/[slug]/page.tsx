...
// Update the params type to use slug instead of id
export default async function CategoryPage({ params }: { params: { slug: string } }) {
  ...
  // Rest of the code remains the same, just make sure to use category.id where needed
  // Get threads for this category
  const threads = await prisma.thread.findMany({
    where: {
      categoryId: category.id, // Use category.id here
    },
    include: {
      author: true,
      _count: {
