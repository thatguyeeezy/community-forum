              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-slate-300">
                    By accessing and using Florida Coast Roleplay ("FCRP"), you agree to abide by these Terms of
                    Service. If you do not agree, you must discontinue use immediately.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    Florida Coast Roleplay is a serious roleplay server. Users must engage in realistic roleplay and
                    adhere to community guidelines. Fail RP, meta-gaming, power-gaming, and other prohibited actions
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    ...
                    property of FCRP. Users may not claim ownership or distribute server-related content without
                    explicit permission.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    FCRP staff reserve the right to enforce community rules at their discretion. Admins and moderators
                    may take actions such as warnings, kicks, bans, or content removal to maintain a fair and respectful
                    environment.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    By using our services, you acknowledge that FCRP may collect and store limited user data, including
                    but not limited to usernames, Discord IDs, and gameplay logs, for moderation and community
                    management purposes. Our full Privacy Policy can be found at{" "}
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    Donations to FCRP are voluntary and non-refundable. Any perks or in-game items received in return
                    for donations are virtual goods and hold no real-world monetary value.
                  </p>
                </section>
