            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-slate-300">
                  By accessing and using Florida Coast Roleplay ("FCRP"), you agree to abide by these Terms of Service.
              ...
              <section>
                ...
                <p className="text-slate-300">
                  ...
                  adhere to community guidelines. Fail RP, meta-gaming, power-gaming, and other prohibited actions will
                  result in disciplinary actions, including bans.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-slate-300">
                  ...
                  but not limited to usernames, Discord IDs, and gameplay logs, for moderation and community management
