      ...
      <div className="container mx-auto py-6 px-4 md:px-6">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-7 gap-8 items-start">
            <div className="lg:col-span-3.5 bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 shadow-sm">
              <p className="text-gray-800 dark:text-gray-200 leading-relaxed whitespace-pre-line">
                {department.aboutUs}
              </p>
            </div>

            <div className="lg:col-span-2.5 flex flex-col items-center justify-center">
