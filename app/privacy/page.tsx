            ...
            <CardContent className="prose dark:prose-invert max-w-none pt-6">
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    We do not share your personal information with third parties, except when required by law, to
                    enforce community guidelines, or in cases of severe rule violations where external authorities may
                    be involved.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    FCRP staff may log server activity to ensure fair play and maintain community integrity. Gameplay
                    logs may be reviewed in case of disputes, rule enforcement, or server maintenance.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-300">
                    ...
                    Protection Act (COPPA), we do not collect or retain data from users under 13 under any
                    circumstances.
                  </p>
                </section>
