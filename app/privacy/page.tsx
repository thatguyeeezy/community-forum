      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            functionality. This includes Discord usernames, in-game character names, IP addresses, and gameplay logs. We
          ...
          <p>
            We take reasonable measures to protect user data from unauthorized access, misuse, or loss. However, users
            acknowledge that no online platform can guarantee complete security.
          </p>

          <h2>6. Community Transparency</h2>
          <p>
            FCRP staff may log server activity to ensure fair play and maintain community integrity. Gameplay logs may
            be reviewed in case of disputes, rule enforcement, or server maintenance.
          </p>

          <h2>7. Age Restrictions</h2>
          <p>
            Florida Coast Roleplay is intended for users aged 16 and older. We do not knowingly collect or store data
            from individuals under 16. If we become aware that an individual under 16 has provided personal data, it
            will be promptly deleted. Additionally, in compliance with the Children's Online Privacy Protection Act
            (COPPA), we do not collect or retain data from users under 13 under any circumstances.
          </p>
